...
class AvaliacaoFixture extends TestFixture
{
    ...
    // phpcs:disable
    public $fields = [
        'cdAvaliacao' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['cdAvaliacao'], 'length' => []],
